<h2><a href="https://www.geeksforgeeks.org/problems/c-data-types1523/1?page=1&category=CPP&difficulty=Basic,Easy&status=unsolved&sortBy=submissions">C++ Data Types</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size:18px">Read a value and store it in the appropriate C++ Data Type.&nbsp;</span></p>
