<h2><a href="https://www.geeksforgeeks.org/problems/c-template/1?page=2&category=CPP&difficulty=Basic,Easy&status=unsolved&sortBy=submissions">C++ Template</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;"><a href="http://quiz.geeksforgeeks.org/templates-cpp/" target="_blank" rel="noopener">Template in C++</a>&nbsp;is a feature. We write code once and use it for any data type including user defined data types.&nbsp;</span></p>
